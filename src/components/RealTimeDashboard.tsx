  ...
  const loadDashboardData = async () => {
    ...
    const mockPatients: PatientStatus[] = [
      ...
      },
      {
        ...
        cycleDay: 21,
        interventionPlan: {
          currentPhase: 'Pre-Treatment Support',
          completedTasks: 8,
          totalTasks: 10,
          nextMilestone: 'Partner Counseling Session',
        },
      },
      {
      ...
      },
      {
        ...
        cycleDay: 15,
        interventionPlan: {
          currentPhase: 'Emotional Support',
          completedTasks: 5,
          totalTasks: 7,
          nextMilestone: 'Transfer Preparation',
        },
      },
    ];
